...
define("esri/dijit/BasemapGallery", "require dojo/_base/declare dojo/_base/array dojo/_base/connect dojo/_base/lang dojo/_base/kernel dojo/_base/sniff dojo/has dojo/query dojo/DeferredList dojo/dom dojo/dom-construct dojo/dom-class dijit/_Widget dijit/_Templated esri/kernel esri/urlUtils esri/request esri/geometry/Extent esri/virtualearth/VETiledLayer esri/layers/OpenStreetMapLayer esri/layers/ArcGISTiledMapServiceLayer esri/layers/ArcGISDynamicMapServiceLayer esri/layers/WebTiledLayer esri/layers/ArcGISImageServiceLayer esri/layers/ImageServiceParameters esri/dijit/Basemap esri/dijit/_EventedWidget dojo/text!esri/dijit/templates/BasemapGallery.html".split(" "), function (h, u, f, n, e, p, I, v, J, w, x, g, q, y, z, k, A, l, r, m, B, C, D, E, s, t, F, G, H) {
    h = u([G, y, z], {declaredClass: "esri.dijit.BasemapGallery", widgetsInTemplate: !0, templateString: H, basePath: h.toUrl("esri/dijit") + "/", loaded: !1, basemaps: [], bingMapsKey: null, flowContainer: null, _hasUI: !1, _selectedBasemap: null, _selectBasemapInProgress: !1, _eventMap: {load: !0, "selection-change": !0, add: ["basemap"], remove: ["basemap"], error: ["message"]}, constructor: function (a, b) {
        a = a || {};
        ...
        this.arcgisUrl = k.dijit._arcgisUrl;
        ...
        f.forEach(this.basemaps, function (a, b) {
            if (!a.id || 0 === a.id.length)a.id = this._getUniqueId();
            f.forEach(a.layers, function (a) {
                a.opacity = 0 <= a.opacity ? a.opacity : 1;
                a.visibility = !0
            }, this)
        }, this);
        this.basemapIds && 0 < this.basemapIds.length && f.forEach(this.basemapIds, function (a) {
            this.map.getLayer(a)._basemapGalleryLayerType = "basemap"
        }, this);
        this.referenceIds && 0 < this.referenceIds.length && f.forEach(this.referenceIds,
            function (a) {
                this.map.getLayer(a)._basemapGalleryLayerType = "reference"
            }, this);
        this.basemapsGroup && (this.basemapsGroup.owner && this.basemapsGroup.title || this.basemapsGroup.id) ? this._findCustomBasemapsGroup(e.hitch(this, "_handleArcGISBasemapsResponse")) : this.showArcGISBasemaps ? this._findArcGISBasemapsGroup(e.hitch(this, "_handleArcGISBasemapsResponse")) : this._finishStartup()
    }, startup: function () {
        this.loaded ? this._refreshUI() : n.connect(this, "onLoad", e.hitch(this, function () {
            this._refreshUI()
        }))
    }, select: function (a) {
        this._select(a)
        ...
        getSelected: function () {
            ...
            var b;
            for (b = 0; b < this.basemaps.length; b++)if (this.basemaps[b].id == a)return this.basemaps[b];
            return null
        }, add: function (a) {
        ...
        }, _defaultBasemapGalleryGroupQuery: 'title:"ArcGIS Online Basemaps" AND owner:esri', _basemapGalleryGroupQuery: null, _finishStartup: function () {
            this.loaded = !0;
            this.onLoad();
            ...
            if (this._basemapGalleryGroupQuery)this._findArcGISBasemapsGroupContent(a); else {
                var b = this.arcgisUrl + "/accounts/self", d = {f: "json"};
                d.culture = p.locale;
                l({url: b,
                    content: d, callbackParamName: "callback", load: e.hitch(this, function (b, d) {
            ...
            var b = e.hitch(this, "_findArcGISBasemaps"), d = this.arcgisUrl + "/community/groups", c = {};
            c.q = this._basemapGalleryGroupQuery;
            c.f = "json";
            l({url: d, content: c, callbackParamName: "callback", load: e.hitch(this, function (d, c) {
                if (0 < d.results.length)b(d.results[0].id, a); else this.onError("esri.dijit.BasemapGallery: could not find group for basemaps.")
            ...
            c.f = "json";
            l({url: d,
                content: c, callbackParamName: "callback", load: e.hitch(this, function (a, d) {
                    if (0 < a.results.length)b(a.results); else this.onError("esri.dijit.BasemapGallery: could not find group for basemaps.")
                }), error: e.hitch(this, function (a, b) {
                    this.onError("esri.dijit.BasemapGallery: could not find group for basemaps.")
                })})
        }, _handleArcGISBasemapsResponse: function (a) {
            0 < a.length && (f.forEach(a, function (a, d) {
                if (this.bingMapsKey || !this.bingMapsKey && a.title && -1 == a.title.indexOf("Bing Maps")) {
                    var c = {};
                    c.id = this._getUniqueId();
                    c.title = a.title;
                    c.thumbnailUrl = "";
                    if (a.thumbnail && a.thumbnail.length && (c.thumbnailUrl = this.arcgisUrl + "/content/items/" + a.id + "/info/" + a.thumbnail, k.id)) {
                        var e = k.id.findCredential(A.urlToObject(this.arcgisUrl).path);
            ...
            this._hasUI && (g.empty(this.flowContainer), f.forEach(this.basemaps, function (a, b) {
            ...
            var b = g.create("div", {id: "galleryNode_" + a.id, "class": "esriBasemapGalleryNode"}), d = g.create("a", {href: "javascript:void(0);"}, b);
            n.connect(d, "onclick", e.hitch(this, "_onNodeClick", a));
            a.thumbnailUrl ? g.create("img", {"class": "esriBasemapGalleryThumbnail", src: a.thumbnailUrl}, d) : g.create("img", {"class": "esriBasemapGalleryThumbnail", src: this.basePath.toString() + "images/transparent.gif"},
                d);
            d = g.create("div", {"class": "esriBasemapGalleryLabelContainer"}, b);
            a = a.title || "";
            g.create("span", {innerHTML: a, alt: a, title: a}, d);
            return b
            ...
            a && (f.forEach(p.query(".esriBasemapGallerySelectedNode", this.domNode), function (a) {
                q.remove(a, "esriBasemapGallerySelectedNode")
            }), (a = x.byId("galleryNode_" + a.id)) && q.add(a, "esriBasemapGallerySelectedNode"))
        }, _select: function (a) {
            this._selectBasemapInProgress = !0;
            var b = this.get(a);
            b ? (b.layers ? this._getServiceInfos(b) : (a = b.getLayers(this.arcgisUrl), e.isArray(a) ? this._getServiceInfos(b) : a.addCallback(e.hitch(this, function (a) {
                this._getServiceInfos(b)
            }))), this._markSelected(b)) : this._selectBasemapInProgress = !1
        }, _getServiceInfos: function (a) {
            var baseMapId= a.id;
            "https:" == location.protocol && f.forEach(a.layers, function (a) {
                if (this._isAgolService(a.url) || this._isHostedService(a.url))a.url = a.url.replace("http:", "https:")
            }, this);
            this._selectedBasemap = a;
            var b = [];
            f.forEach(a.layers, function (a) {
                e.mixin(a,{id:baseMapId});
                a.url &&
                (0 < a.url.length && !a.isReference && !a.type) && (a.deferredsPos = b.length, b.push(this._getServiceInfo(a.url)))
            }, this);
            0 < b.length ? (new w(b)).addCallback(e.hitch(this, function (b) {
                var c = null;
                f.forEach(a.layers, function (a) {
            ...
            var baseMapId=a.id;
            a = a.layers;
            if (0 < this.map.layerIds.length && 0 === this.map.getNumLevels() && ("OpenStreetMap" === a[0].type || a[0].type && -1 < a[0].type.indexOf("BingMaps") || "WebTiledLayer" === a[0].type))this.onError("esri.dijit.BasemapGallery: Unable to switch basemap because new basemap is a tiled service and cannot be loaded as a dynamic layer."); else {
                ...
                f.forEach(a, function (a) {
                    ...
                    if (!a.isReference) {
                        ...
                        if ("OpenStreetMap" === a.type) {
                            ...
                            c = new B({id: "layer_osm", opacity: a.opacity})
                        } else if (a.type &&
                            ...
                            c = m.MAP_STYLE_AERIAL_WITH_LABELS;
                            "BingMapsAerial" == a.type ? c = m.MAP_STYLE_AERIAL : "BingMapsRoad" == a.type && (c = m.MAP_STYLE_ROAD);
                            c = new m({id: "layer_bing", bingMapsKey: this.bingMapsKey, mapStyle: c, opacity: a.opacity})
            ...
            this._getServiceInfo(a.url, e.hitch(this, "_handleReferenceServiceInfoResponse", a))
        }, _handleReferenceServiceInfoResponse: function (a, b, d) {
            var c;
            (a.serviceInfoResponse = b) && b.mapName ? c = !0 === b.singleFusedMapCache ? this._loadAsCached(a) : this._loadAsDynamic(a) : b && b.pixelSizeX && (d = new t, d.bandIds = a.bandIds, !a.bandIds && (b.bandCount &&
                3 < parseInt(b.bandCount)) && (d.bandIds = [0, 1, 2]), c = new s(a.url, {id: a.id,resourceInfo: b, opacity: a.opacity, visible: a.visibility, imageServiceParameters: d}));
            c && (c._basemapGalleryLayerType = "reference", this.map.addLayer(c))
        }, _getServiceInfo: function (a, b) {
            return l({url: a, content: {f: "json"}, callbackParamName: "callback", load: function (a, c) {
                b && b(a, c)
            }, error: e.hitch(this, function (a, b) {
            ...
            var b = [];
            a.displayLevels || (b = f.map(a.serviceInfoResponse.tileInfo.lods,
                function (a) {
                    return a.level
                }));
            return new C(a.url, {id: a.id,resourceInfo: a.serviceInfoResponse, opacity: a.opacity, visible: a.visibility, displayLevels: a.displayLevels || b})
        }, _loadAsDynamic: function (a) {
            var b = new D(a.url, {id: a.id,resourceInfo: a.serviceInfoResponse, opacity: a.opacity, visible: a.visibility});
            a.visibleLayers && b.setVisibleLayers(a.visibleLayers);
            return b
        }, _getIntersectionPercent: function (a, b) {
            var d = b.intersects(a);
            if (d) {
                var d = d.getWidth() * d.getHeight(), c = b.getWidth() * b.getHeight();
                return 100 * (d / c)
            }
            return 0
        }, _getIds: function () {
            var a =
                [];
            f.forEach(this.basemaps, function (b) {
                a.push(b.id)
            }, this);
            return a
        }, _getUniqueId: function () {
            for (var a = "," + this._getIds().toString() + ",", b = 0; ;)if (-1 < a.indexOf(",basemap_" + b + ","))b++; else return"basemap_" + b
    ...
    v("extend-esri") && e.setObject("dijit.BasemapGallery", h, k);
    return h
});